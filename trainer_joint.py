...
from models.vha_joint import Autoencoder as Autoencoder
from utils.trainer_base import TrainerBase


class TrainerJoint(TrainerBase):
    ...
    def test(self):
        ...
        for step, sample in enumerate(self.val_loader):
            ...
            y_pred = utils.get_multi_local_maxima_3d(hmaps3d=hmap_pred.squeeze(), threshold=0.1,
